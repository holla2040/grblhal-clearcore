 ...
 * Housekeeping per tick: grblHAL delay hook, shift-register refresh,
 * ~1 Hz underglow alive-blink. hal.get_elapsed_ticks reads millis().
 *
...
void SysTick_Handler(void)
{
    ...
    /* ~1 Hz underglow blink: "firmware alive" indicator */
    if ((tick_ms & 0x1FF) == 0) {
